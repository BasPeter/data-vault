# Sidebar Document Selection Spec

## Purpose

Defines how the expanded document sidebar communicates the currently active
document visually and to accessibility tooling.
